...
##------------------------------------------------------------------
## load model for pH prediction given data decimation factor of 50
##------------------------------------------------------------------

# save models to disk
load(file = "saved_models/fitPh.lm.50.RData")
load(file = "saved_models/fitPh.bagEarth.50.RData")
load(file = "saved_models/fitPh.bagEarthGCV.50.RData")
load(file = "saved_models/fitPh.earth.50.RData")
load(file = "saved_models/fitPh.gcvEarth.50.RData")
load(file = "saved_models/fitPh.rf.50.RData")



##------------------------------------------------------------------
## load model for pH prediction given data decimation factor of 10
##------------------------------------------------------------------

# save models to disk
load(file = "saved_models/fitPh.lm.10.RData")
load(file = "saved_models/fitPh.bagEarth.10.RData")
load(file = "saved_models/fitPh.bagEarthGCV.10.RData")
load(file = "saved_models/fitPh.earth.10.RData")
load(file = "saved_models/fitPh.gcvEarth.10.RData")
load(file = "saved_models/fitPh.rf.10.RData")



##------------------------------------------------------------------
## load model for pH prediction given data decimation factor of 5
##------------------------------------------------------------------

load(file = "saved_models/fitPh.lm.5.RData")
load(file = "saved_models/fitPh.bagEarth.5.RData")
load(file = "saved_models/fitPh.bagEarthGCV.5.RData")
load(file = "saved_models/fitPh.earth.5.RData")
load(file = "saved_models/fitPh.gcvEarth.5.RData")
load(file = "saved_models/fitPh.rf.5.RData")
...
inTrain  <- createDataPartition(y=procData$pH, p=0.75, list=FALSE)
errors10 <- getRmsVector(fitPh.lm.10,fitPh.bagEarth.10,
                         fitPh.bagEarthGCV.10,fitPh.earth.10,
                         fitPh.gcvEarth.10,fitPh.rf.10,
                         "Ph",infraredData,10,inTrain)
set.seed(1234)
procData <- createModelingData("ph",infraredData,5)
inTrain  <- createDataPartition(y=procData$pH, p=0.75, list=FALSE)
errors5 <- getRmsVector(fitPh.lm.5,fitPh.bagEarth.5,
                         fitPh.bagEarthGCV.5,fitPh.earth.5,
                         fitPh.gcvEarth.5,fitPh.rf.5,
                         "Ph",infraredData,5,inTrain)
